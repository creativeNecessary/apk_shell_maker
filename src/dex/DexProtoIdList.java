...
public class DexProtoIdList extends DexItem {
    public static int ITEM_LENGTH = 12;

    private DexProtoIdList(DexHeader dexHeader) {
        super(dexHeader);
        originDataList = new ArrayList<>();
        int start_off = dexHeader.getProtoIdsOff();
    ...
    public static DexProtoIdList init(DexHeader dexHeader) {

        return new DexProtoIdList(dexHeader);
    }
}
